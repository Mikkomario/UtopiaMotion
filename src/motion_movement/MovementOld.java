...
public class MovementOld
{
	 ...
	 */
	public MovementOld(double hspeed, double vspeed)
	{
	 ...
	 */
	public MovementOld(MovementOld other)
	{
	 ...
	 */
	public static MovementOld createMovement(double direction, double speed)
	{
		MovementOld newmovement = new MovementOld(0, 0);
	 ...
	 */
	public MovementOld getOpposingMovement()
	{
		return new MovementOld(-getHSpeed(), -getVSpeed());
	}
	 ...
	 */
	public MovementOld getDirectionalMovement(double direction)
	{	
	 ...
	 */
	public MovementOld getMultiplication(double multiplier)
	{
		return new MovementOld(getHSpeed() * multiplier, getVSpeed() * multiplier);
	}
	 ...
	 */
	public MovementOld getDirectionalllyDiminishedMovement(double direction, 
			double speedloss)
	{
		// Divides the movement into two ("x" and "y") movements
		MovementOld dirmovement = getDirectionalMovement(direction);
		MovementOld othermovement = getDirectionalMovement(direction + 90);
		...
		return MovementOld.movementSum(dirmovement, othermovement);
	}
	 ...
	 */
	public static MovementOld movementSum(MovementOld movement1, MovementOld movement2)
	{
		...
		return new MovementOld(hspeed, vspeed);
	}
	 ...
	 */
	public static MovementOld movementMultiplication(MovementOld movement1, 
			MovementOld movement2)
	{
	 ...
	 */
	public static MovementOld getMultipliedMovement(MovementOld movement, 
			double multiplier)
	{
		MovementOld returnvalue = new MovementOld(movement);
