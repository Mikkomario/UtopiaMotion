...
import conflict_collision.CollidingDrawnObject;
import conflict_collision.CollisionType;
...
{	
			...
			CollisionType collisiontype, AreaOldVersion area)
	{
		...
		this.movement = new MovementOld(0, 0);
		this.rotation = 0;
		this.friction = 0;
		this.rotFriction = 0;
		this.maxspeed = -1;
	 ...
	 */
	public MovementOld getMovement()
	{
	...
	{
		this.movement = new MovementOld(hspeed, vspeed);
	}
	 ...
	 */
	public void setMovement(MovementOld movement)
	{
	...
	{
		this.movement = MovementOld.movementSum(getMovement(), 
				new MovementOld(haccelration, vacceltarion));
	}
	...
	{
		this.movement = MovementOld.movementSum(getMovement(), 
				MovementOld.createMovement(direction, speedChange));
	}
	...
	{	
		this.movement = MovementOld.createMovement(direction, speed);
	}
	...
	{
		addPosition(MovementOld.getMultipliedMovement(getMovement(), steps));
